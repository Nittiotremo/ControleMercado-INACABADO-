...
public class GravarProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int codigoProduto = request.getParameter("codigoProduto").isEmpty() ? 0 : Integer.parseInt(request.getParameter("codigoMarca"));
            ...
            request.setAttribute("mensagem", "Produto gravada com sucesso");
